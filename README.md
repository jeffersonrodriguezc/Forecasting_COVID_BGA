...
#### Modelos explorados:
Los modelos siguieron dos estructuras o formas de uso: Recursivo y multi-modelo por días. Para los de DL se exploró el uso de multiples variables para los modelos ML solo univariables.
